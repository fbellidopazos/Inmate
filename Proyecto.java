...
public class Proyecto{
  ...
  public static int errorFila (int [][] tablero){174
...
//COMANDOS FUNDAMENTALES.
  ...
  public static String description(int sala){
    ...
    switch(sala){
      ...
      case 3:des = "Te encuentras en la enfermeria. En esta sala, suele estar el enfermero,\nun amable señor que ha dedicado toda su vida a esta carcel. Es posible que sea la persona mas graciosa de este lugar.\nAdemas se observan.....";break;
      case 4:des = "Este es el comedor. Aquí comes todos los dias esa basura a la que llaman comida, pero aunque está mala, es tu sala favorita. ¡Te encantan las natillas! A la derecha esta tu mesa de todos los dias, al fondo a la derecha esta el viejo armario en el que         necesitas tornillo chica en una silla, se acerca a hablarla y ...";;break;
      case 5:des = "";break;
  ...
  public static void main(String[] args) {
    Scanner sc = new Scanner(System.in);
    System.out.println("-------------------------------------------------------------------------\nBienvenid@ a INMATE.");
    int[] inventory = {0,0,0,0,0,0,0,0}; //Cuatro objetos 
  ...
  //Lista de los Objetos en el inventario
  ...
  //El codigo del NIVEL de DIFICULTAD genera el código final
      ...
      switch(sala3Input){
        ...
        case "ppt":
          if(inventory[2]==1){
            ...
            if(ppt1(ingame[1]))
              System.out.println("Bueno, bueno, esto no se te da nada mal. Aqui esta tu pista: **");
          }else
  ...
  public static void sala4(int[] inventory,int[] ingame){
    ...
    while(true){
      ...
      switch(sala4Input){
        ...
        case "oeste":pasillo(inventory,ingame);break;
        case "help":System.out.println(howto(3));break;
       // Cuando te sientas a recuperar el aliento tras la
        case "exit":exit();break;
        default: System.out.println("Ese comando no existe. Escribe 'help' si necesitas recibir ayuda.");break;
      }
    }
